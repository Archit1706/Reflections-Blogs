...
const HeadLineCards = (props: Props) => {
    ...
    return (
        <div className="max-w-[1420px] mx-auto p-4 py-12 space-y-5 dark:bg-zinc-800 mt-12 bg-white">
            <h1 className="text-center mb-4 text-3xl lg:text-4xl tracking-tight font-extrabold text-zinc-800 dark:text-white">
                MORE TO READ
            </h1>
