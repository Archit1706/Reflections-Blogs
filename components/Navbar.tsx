...
import Logo from "../assets/Reflections.png";
// import Logo from "../assets/Reflection_2.png";
type Props = {
    ...
    return (
        <div className="max-w-[1420px] mx-auto flex justify-center items-center sticky top-0 z-100">
            <Nav
                // fluid={true}
                rounded={true}
                className="bg-white px-2 sm:px-4 py-2.5 dark:bg-zinc-800 w-full z-20 border-b border-zinc-200 dark:border-zinc-600"
            >
                <div className="container flex flex-wrap items-center justify-between mx-auto">
                    ...
                    >
                        {/* <img src={Logo.src} className="mr-3 w-12" alt="Logo" />
                        <span className="self-center text-xl font-semibold whitespace-nowrap dark:text-white">
                            Reflections
                        </span> */}

                        <div className="self-center text-xl font-semibold whitespace-nowrap dark:text-white content mt-6 md:mt-10">
            ...
            <div className="relative w-full">
              <label
                htmlFor="email"
                className="hidden mb-2 text-sm font-medium text-zinc-900 dark:text-zinc-300"
              >
                Email address
              </label>
              ...
              <input
                className="block p-3 pl-10 w-full text-sm text-zinc-900 bg-zinc-50 rounded-lg border border-zinc-300 sm:rounded-none sm:rounded-l-lg focus:ring-primary-500 focus:border-primary-500 dark:bg-zinc-700 dark:border-zinc-600 dark:placeholder-zinc-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                placeholder="Search"
                type="text"
                id="search"
                value={query}
            ...
            <button
              ...
              id="theme-toggle"
              type="button"
              className="hidden md:block text-zinc-500 dark:text-zinc-400 hover:bg-zinc-100 dark:hover:bg-zinc-700 focus:outline-none focus:ring-4 focus:ring-zinc-200 dark:focus:ring-zinc-700 rounded-lg text-sm p-2.5 md:float-right md:mr-4"
            >
              <svg
                        ...
                        <span className="ml-auto">
                            {currTheme.length > 0 ? (
                                <button
                                    ...
                                    id="theme-toggle"
                                    type="button"
                                    className="text-zinc-500 dark:text-zinc-400 hover:bg-zinc-100 dark:hover:bg-zinc-700 focus:outline-none focus:ring-4 focus:ring-zinc-200 dark:focus:ring-zinc-700 rounded-lg text-sm p-2.5 md:float-right md:mr-4"
                                >
                                    <svg
                                        id="theme-toggle-dark-icon"
                                        className={`${
